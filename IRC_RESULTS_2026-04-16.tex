...
\begin{figure}[h]
\centering
\includegraphics[width=\textwidth]{figures/fig_sella_rates_vs_noise.pdf}
\caption{IRC validation rates vs.\ starting TS noise. Topology success is nearly
flat at $\sim$93--94\% through 100\,pm, steps down to 90.7\% at 150\,pm, and
drops to 80.4\% at 200\,pm. Strict RMSD-intended is roughly \emph{flat or
slightly rising} through 150\,pm (64--67\%) before dropping at 200\,pm ---
implying the strict-RMSD failures are not noise-driven; they are
conformational or labeling-driven.}
\end{figure}
...
\begin{figure}[h]
\centering
\includegraphics[width=\textwidth]{figures/fig_sella_endpoint_quality.pdf}
\caption{Fraction of IRC endpoints classified by vibrational quality. Both
endpoints are true minima in 87--90\% of runs across all noise levels.
``neither at minimum'' (integrator stalled on a ridge) is 0.5--1.8\% ---
a tight upper bound on genuine IRC failure.}
\end{figure}
