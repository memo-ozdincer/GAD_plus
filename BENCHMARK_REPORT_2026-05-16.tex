...
Sella internal tuned Hess.Freq.=1           & 79.1 & 77.4 & 71.8 & 50.9 & 41.4$^{p_{58}}$ & 16.1$^{p_{112}}$ \\
Sella cartesian Eckart untuned Hess.Freq.=3 & \textbf{96.5} & \textbf{95.5} & \textbf{92.0} & 72.8 & 50.5 & 25.0$^{p_{144}}$ \\
\midrule
...
\textbf{Linear midpoint (R+P)/2}        & \textbf{52.2\%$^{p_{90}}$} & ---    \\
Reactant                                & 80.8\%   & 89.9\% \\
\bottomrule
\end{tabular}
\end{center}
...
200 pm & \textbf{27.2} & 25.0$^{p_{144}}$ & $-2.2$ & 107.0 / pending \\
\bottomrule
\end{tabular}
\end{center}
