...
<main class="wrap">
  ...
  <section class="card"><div class="section-title"><div><h2>Evaluations to local TS convergence</h2><p>Median local Hessian evaluations among local TS candidates only; failed starts are not treated as fast runs.</p></div></div><div id="effortPlot" class="overview-plot"></div></section>
  <section class="card">
    ...
    <div class="aggregate-wrap"><table><thead><tr><th>Method</th><th>Noise</th><th>Starts</th><th>Local TS</th><th>Strict TS</th><th>IRC endpoints</th><th>IRC/native event</th><th>End index 0</th><th>End index &gt;1</th><th>Median evals / local TS</th></tr></thead><tbody id="aggregateBody"><tr><td colspan="10">Loading…</td></tr></tbody></table></div>
  </section>
  <section class="card">
