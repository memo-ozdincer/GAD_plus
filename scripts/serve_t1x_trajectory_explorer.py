...
<main class="wrap">
  <section class="card"><div class="section-title"><div><h2>Local index-1 candidate recovery versus noise</h2><p>Projected index one and <i>F</i><sub>max</sub>&lt;0.03 at the terminal point. This is local convergence only; it does not establish chemical connectivity.</p></div><div class="tabs"><button class="tab active" data-surface="gxtb">g-xTB</button><button class="tab" data-surface="lj7">LJ7</button></div></div><div id="localPlot" class="overview-plot"></div></section>
  <section class="card"><div class="section-title"><div><h2>Endpoint-validated event recovery versus noise</h2><p>Primary criterion: runs satisfying the declared two-downhill-branch topology / event criterion, divided by all starts. This is an endpoint screen, not a full IRC integration.</p></div></div><div id="ircPlot" class="overview-plot"></div></section>
