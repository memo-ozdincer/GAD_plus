...
Sella internal tuned Hess.Freq.=1           & 79.1 & 77.4 & 71.8 & 50.9 & 41.3$^{p_{63}}$ & 14.9$^{p_{121}}$ \\
Sella cartesian Eckart untuned Hess.Freq.=3 & \textbf{96.5} & \textbf{95.5} & \textbf{92.0} & 72.8 & 50.5 & 23.6$^{p_{157}}$ \\
\midrule
...
\textbf{Linear midpoint (R+P)/2}        & \textbf{52.9\%$^{p_{102}}$} & ---    \\
Reactant                                & 80.8\%   & 89.9\% \\
\bottomrule
\end{tabular}
\end{center}
...
200 pm & \textbf{27.2} & 23.6$^{p_{157}}$ & $-3.6$ & 107.0 / pending \\
\bottomrule
\end{tabular}
\end{center}
