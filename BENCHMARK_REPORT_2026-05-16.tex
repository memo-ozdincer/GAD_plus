...
Sella internal tuned Hess.Freq.=1           & 79.1 & 77.4 & 71.8 & 50.9 & 40.3$^{p_{72}}$ & 15.8$^{p_{146}}$ \\
Sella cartesian Eckart untuned Hess.Freq.=3 & \textbf{96.5} & \textbf{95.5} & \textbf{92.0} & 72.8 & 50.5 & 22.0$^{p_{186}}$ \\
\midrule
...
\textbf{Linear midpoint (R+P)/2}        & \textbf{53.7\%$^{p_{121}}$} & ---    \\
Reactant                                & 80.8\%   & 89.9\% \\
\bottomrule
\end{tabular}
\end{center}
...
200 pm & \textbf{27.2} & 22.0$^{p_{186}}$ & $-5.2$ & 107.0 / pending \\
\bottomrule
\end{tabular}
\end{center}
