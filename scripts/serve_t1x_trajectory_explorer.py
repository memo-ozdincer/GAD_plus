...
<main class="wrap">
  <section class="card"><div class="section-title"><div><h2>IRC-validated event recovery versus noise</h2><p>Primary criterion: runs satisfying the declared two-downhill-branch topology / event criterion, divided by all starts.</p></div><div class="tabs"><button class="tab active" data-surface="gxtb">g-xTB</button><button class="tab" data-surface="lj7">LJ7</button></div></div><div id="ircPlot" class="overview-plot"></div></section>
  <section class="card"><div class="section-title"><div><h2>Wall time to local TS convergence</h2><p>Median observed optimizer wall time among local TS candidates only; failed starts are not treated as fast runs.</p></div></div><div id="effortPlot" class="overview-plot"></div></section>
  <section class="card">
    <div class="section-title"><div><h2>Method overview</h2><p>All campaign outcomes, grouped by noise. The chart and table use the same selected surface.</p></div></div>
    <div class="aggregate-wrap"><table><thead><tr><th>Method</th><th>Noise</th><th>Starts</th><th>Local TS</th><th>Strict TS</th><th>IRC endpoints</th><th>IRC/native event</th><th>End index 0</th><th>End index &gt;1</th><th>Median wall time / local TS</th></tr></thead><tbody id="aggregateBody"><tr><td colspan="10">Loading…</td></tr></tbody></table></div>
  </section>
  <section class="card">
