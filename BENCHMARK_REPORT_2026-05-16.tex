...
Sella internal tuned Hess.Freq.=1           & 79.1 & 77.4 & 71.8 & 50.9 & 40.4$^{p_{52}}$ & 16.3$^{p_{98}}$ \\
Sella cartesian Eckart untuned Hess.Freq.=3 & \textbf{96.5} & \textbf{95.5} & \textbf{92.0} & 72.8 & 50.5 & 23.8$^{p_{126}}$ \\
\midrule
...
\textbf{Hybrid runs from the reactant are not yet in the benchmark} — the
existing hybrid runner only takes a noised-TS starting condition; a follow-up
is queued. Source: \texttt{reactant\_0pm\_2026\_05\_16.csv}.}
\end{figure}
...
\textbf{Linear midpoint (R+P)/2}        & \textbf{47.3\%$^{p_{74}}$} & ---    \\
Reactant                                & 80.8\%   & 89.9\% \\
\bottomrule
\end{tabular}
\end{center}
...
200 pm & \textbf{27.2} & 23.8$^{p_{126}}$ & $-3.4$ & 107.0 / pending \\
\bottomrule
\end{tabular}
\end{center}
