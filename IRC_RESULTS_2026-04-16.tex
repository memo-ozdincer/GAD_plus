...
\caption{Topology criterion. Flat at $\sim$94\% through 100\,pm; steps down
to 90.7\% at 150\,pm; drops to 80.4\% at 200\,pm. Denominator is the
\texttt{gad\_dt003}-converged TS pool at each noise.}
\end{figure}
...
\caption{Strict RMSD criterion. Roughly flat at 60--67\% across noise
levels; the gap to topology is absorbed mostly by the half-intended tier.}
\end{figure}
...
\caption{Endpoint vibrational quality. Both-at-minimum rises gently from
87.7\% at 10\,pm to 89.5\% at 200\,pm. Ridge-stalls are 0.5--1.8\% ---
a tight upper bound on pure integrator failure.}
\end{figure}
