...
\begin{center}\footnotesize
\textbf{Table 1 — TS conv \%} (Im. Freq. $\wedge$ $F_{\max}<0.01$, $n=287$)\\[0.3em]
...
Sella internal tuned Hess.Freq.=1           & 79.1 & 77.4 & 71.8 & 50.9 & ---  & ---  \\
Sella cartesian Eckart untuned Hess.Freq.=3 & \textbf{96.5} & \textbf{95.5} & \textbf{92.0} & 72.8 & 50.5 & 23.3 (partial) \\
\midrule
...
Sella Hess.Freq.=3 (gray heads if IRC not available).}
\end{figure}
